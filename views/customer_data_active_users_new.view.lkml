...
view: customer_daily_active_users_new  {
  ...
  dimension: date_range_activity {
    ...
    link: {
      ...
      url: "/dashboards/1501?&f[customer_daily_active_users_new.date_range_activity]={{ date_range_activity }}&Product={{ _filters['customer_daily_active_users_new.product'] | url_encode }}&Date={{ value }}"
    ...
    sql: DATE(${TABLE}.date_range_activity) ;;
  }
