...
view: customer_daily_active_users_new  {
  ...
  dimension: date_range_activity {
    ...
    link: {
      ...
      url: "/explore/workinsights/customer_daily_active_users_new?fields=customer_daily_active_users_new.date_range_activity,customer_daily_active_users_new.gaia_id&f[customer_daily_active_users_new.date_range_activity]={{ filterable_value }}"
