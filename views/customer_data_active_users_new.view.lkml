...
view: customer_daily_active_users_new  {
  ...
  dimension: date_range_activity {
    ...
    link: {
      ...
      url: "/dashboards/1501?fields=customer_daily_active_users_new.gaia_id,customer_daily_active_users_new.date_range_activity&f[customer_daily_active_users_new.date_range_activity]={{ value }}&Product={{ _filters['customer_daily_active_users_new.product'] | url_encode }}&Date={{ value }}"
